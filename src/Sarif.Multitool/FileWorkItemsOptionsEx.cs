...
{
    [Verb("file-work-items-ex", HelpText = "Send SARIF results to a work item tracking system such as GitHub or Azure DevOps")]
    public class FileWorkItemsOptionsEx : SingleFileOptionsBase
    {
        [Option(
            "project-uri",
