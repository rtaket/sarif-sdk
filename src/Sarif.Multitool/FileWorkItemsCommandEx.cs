...
using Microsoft.CodeAnalysis.Sarif.WorkItems.Pipeline;
...
namespace Microsoft.CodeAnalysis.Sarif.Multitool
{
    ...
    /// </summary>
    internal class FileWorkItemsCommandEx : CommandBase
    {
        [ThreadStatic]
        internal static bool s_validateOptionsOnly;

        public int Run(FileWorkItemsOptionsEx options)
            => Run(options, new FileSystem());

        public int Run(FileWorkItemsOptionsEx options, IFileSystem fileSystem)
        {
            ...
            var filingContext = new SarifWorkItemContextEx(sarifLog, new Uri(options.ProjectUri));
            ...
            using (var filer = new SarifWorkItemFilerEx())
            {
                filer.FileWorkItems(filingContext);
        ...
        private bool ValidateOptions(FileWorkItemsOptionsEx options, SarifWorkItemContextEx sarifWorkItemContext, IFileSystem fileSystem)
        {
            bool valid = true;
